...
OWNER_USER_ID=
ALLOWED_USER_IDS=
# Bluetooth presence tuning (optional; these are the defaults)
#BT_POLL_INTERVAL_SECONDS=600
#BT_PROBE_TIMEOUT_SECONDS=8
#BT_PROBE_ATTEMPTS=3
#BT_PROBE_RETRY_DELAY_SECONDS=1
#BT_DISCOVERY_TIMEOUT_SECONDS=15
#BT_PAIR_TIMEOUT_SECONDS=180
#BT_PASSKEY_CONFIRM_TIMEOUT_SECONDS=90
EOF
    chmod 600 .env
